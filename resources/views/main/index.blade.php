...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/animate/animate.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/animate/custom-animate.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/bootstrap/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/bxslider/jquery.bxslider.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/fontawesome/css/all.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/jquery-ui/jquery-ui.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/nice-select/nice-select.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/odometer/odometer.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/owl-carousel/owl.carousel.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/owl-carousel/owl.theme.default.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/swiper/swiper.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/vegas/vegas.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/thm-icons/style.css') }}">
    <link rel="stylesheet" href="{{ asset('mainassets/assets/vendors/language-switcher/polyglot-language-switcher.css') }}">
    <!-- Module css -->
    <link rel="stylesheet" href="{{ asset('mainassets/assets/css/module-css/01-header-section.css') }}">
    <link rel="stylesheet" href="{{ asset('mainassets/assets/css/module-css/02-banner-section.css') }}">
    <link rel="stylesheet" href="{{ asset('mainassets/assets/css/module-css/03-about-section.css') }}">
    <link rel="stylesheet" href="{{ asset('mainassets/assets/css/module-css/04-fact-counter-section.css') }}">
    <link rel="stylesheet" href="{{ asset('mainassets/assets/css/module-css/05-testimonial-section.css') }}">
    <link rel="stylesheet" href="{{ asset('mainassets/assets/css/module-css/06-partner-section.css') }}">
    <link rel="stylesheet" href="{{ asset('mainassets/assets/css/module-css/07-footer-section.css') }}">
    <link rel="stylesheet" href="{{ asset('mainassets/assets/css/module-css/08-blog-section.css') }}">

    <!-- Template styles -->
    <link rel="stylesheet" href="{{ asset('mainassets/assets/css/style.css') }}" />
    <link rel="stylesheet" href="{{ asset('mainassets/assets/css/responsive.css') }}" />
...
<body>
            ...
            <div id="handle-preloader" class="handle-preloader">
                <div class="animation-preloader">
                    ...
                    <div class="txt-loading">
                        ...
                        <span data-text-preloader="NG" class="letters-loading">
                            NG
                        </span>
                    </div>
                </div>
    ...
    <div class="page-wrapper">
                ...
                <div class="auto-container">
                    <div class="outer-box">
                        <div class="update-box">
                            ...
                            <div class="text">
                                <p>Get upto 4%* on our Savings Account Balances with {{ ucfirst(config('app.name')) }}.</p>
            ...
            <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image: url({{ asset('mainassets/assets/images/slides/slide-v1-1.jpg') }});">
                        </div>
                        <div class="main-slider-style1__shape1" style="background-image: url({{ asset('mainassets/assets/images/shapes/slider-1-shape-1.png') }});">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="main-slider-content">
                                        <div class="main-slider-content__inner">
                                            ...
                                            <div class="text">
                                                <p>
                                                    On the other hand, we denounce with righteous indignation<br> and dislike men who are so beguiled.
                                                </p>
                                            </div>
                                            <div class="btns-box">
                    ...
                    <!--Start Single Swiper Slide-->
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image: url({{ asset('mainassets/assets/images/slides/slide-v1-2.jpg') }});">
                        </div>
                        <div class="main-slider-style1__shape1" style="background-image: url({{ asset('mainassets/assets/images/shapes/slider-1-shape-1.png') }});">
                        </div>
                        <div class="container">
                                ...
                                <div class="col-xl-12">
                                    <div class="main-slider-content">
                                        <div class="main-slider-content__inner">
                                            ...
                                            <div class="text">
                                                <p>
                                                    Their duty through weakness of will, which is the same as<br> saying through shrinking from toil.
                                                </p>
                                            </div>
                                            <div class="btns-box">
                                                <a class="btn-one" href="add-property.html">
                    ...
                    <!--Start Single Swiper Slide-->
                    <div class="swiper-slide">
                        <div class="image-layer" style="background-image: url({{ asset('mainassets/assets/images/slides/slide-v1-3.jpg') }});">
                        </div>
                        <div class="main-slider-style1__shape1" style="background-image: url({{ asset('mainassets/assets/images/shapes/slider-1-shape-1.png') }});">
                        </div>
                        <div class="container">
                        ...
                        <li>
                            <div class="single-features-style1-box">
                                <div class="shape-left">
                                    <img src="{{ asset('mainassets/assets/images/shapes/shape-1.png') }}" alt="">
                                </div>
                                <div class="shape-bottom">
                                    <img src="{{ asset('mainassets/assets/images/shapes/shape-2.png') }}" alt="">
                                </div>
                                <div class="counting-box">
                                    <div class="counting-box-bg" style="background-image: url({{ asset('mainassets/assets/images/shapes/counting-box-bg.png') }});"></div>
                                    <h3>01</h3>
                                </div>
                                <div class="text-box">
                                    <h4>Fixed Depost</h4>
        ...
        <!--Start Service Style1 Area-->
            {{-- <section class="service-style1-area">
                <div class="service-style1-bg" style="background-image: url({{ asset('mainassets/assets/images/backgrounds/service-style1.jpg') }});">
                </div>
                <div class="container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4 col-lg-4">
                                                    <div class="single-service-box-style1">
                                                        ...
                                                        <div class="border-box"></div>
                                                        <p>Equal blame belongs to those who fail their duty through weakness.
                                                        </p>
                                                ...
                                                <div class="col-xl-4 col-lg-4">
                                                    <div class="single-service-box-style1">
                                                        ...
                                                        <div class="border-box"></div>
                                                        <p>Duty or the obligations of business will frequently occur repudiated.
                                                        </p>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="features-style3-img-box">
                            <div class="inner-img">
                                <img class="paroller" src="{{ asset('mainassets/assets/images/resources/features-style3-img.png') }}" alt="">
                            </div>
                                ...
                                <div class="apply-credit-card">
                                    ...
                                    <form id="apply-credit-card" name="apply-credit-card" action="#" method="post">
                                        ...
                                        <div class="button-box">
                                            <a class="btn-one" href="#mobile-app" data-loading-text="Please wait...">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="faq-style1__image">
                            <div class="inner">
                                <img src="{{ asset('mainassets/assets/images/resources/faq-style1__image.jpg') }}" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="owl-carousel owl-theme thm-owl__carousel deals-carousel-one owl-nav-style-one" data-owl-options='{
                        ...
                        <div class="single-deals-box">
                            <div class="text-box">
                                ...
                                <p>Claims off duty or the obligations business it will frequently occur that pleasures be repudiated.</p>
                                <ul>
                                    <li>
                                        <div class="inner">
                                            <div class="icon">
                            ...
                            <div class="img-box">
                                <div class="img-bg" style="background-image: url({{ asset('mainassets/assets/images/resources/deals-1.jpg') }});">
                                </div>
                        ...
                        <div class="single-deals-box">
                            ...
                            <div class="img-box">
                                <div class="img-bg" style="background-image: url({{ asset('mainassets/assets/images/resources/deals-2.jpg') }});">
                                </div>
                                <div class="shape-left-1"></div>
                                <div class="shape-right-1"></div>
                                <div class="shape-right-2"></div>
                            ...
                            <div class="single-footer-widget single-footer-widget--link-box">
                                ...
                                <div class="footer-widget-links">
                                    <ul>
                                        ...
                                        <li><a href="#">Car Banking</a></li>
                                        <li><a href="#">Two Banking</a></li>
                            ...
                            <div class="single-footer-widget marbtm50">
                                <div class="our-company-info">
                                    ...
                                    <div class="copyright-text">
                                        <p>
                                            Copyright &copy; 2022 <a href="index.html">{{ ucfirst(config('app.name')) }}.</a> Licensed by the<br> Central Bank of United States.
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="{{ asset('mainassets/assets/vendors/jquery/jquery-3.6.0.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/bxslider/jquery.bxslider.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/circleType/jquery.circleType.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/circleType/jquery.lettering.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/isotope/isotope.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/jquery-ajaxchimp/jquery.ajaxchimp.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/jquery-appear/jquery.appear.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/jquery-migrate/jquery-migrate.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/jquery-ui/jquery-ui.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/jquery-validate/jquery.validate.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/nice-select/jquery.nice-select.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/odometer/odometer.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/owl-carousel/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/swiper/swiper.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/vegas/vegas.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/wnumb/wNumb.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/wow/wow.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/extra-scripts/jquery.paroller.min.js') }}"></script>
    <script src="{{ asset('mainassets/assets/vendors/language-switcher/jquery.polyglot.language.switcher.js') }}"></script>

    <!-- Template js -->
    <script src="{{ asset('mainassets/assets/js/custom.js') }}"></script>
